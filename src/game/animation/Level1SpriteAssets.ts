...
export const WUKONG_OPENING_RUN_FRAME_RATE = 25 / 6;
...
export const level1SpriteAssets: readonly Level1SpriteAsset[] = [
  ...
  },
  {
    ...
    frameRate: 1,
    hitFrame: null,
    sourceSheet: "NPC赞扬(1).png",
    outputDirectory: "level1/guard/praise"
  },
  {
  ...
  },
  {
    ...
    frameCount: 5,
    playback: "loop",
    frameRate: WUKONG_OPENING_RUN_FRAME_RATE,
    hitFrame: null,
