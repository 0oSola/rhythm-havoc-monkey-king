...
export const NORMAL_CONFIRM_SFX_KEY = "level1_dialogue_confirm_sfx";
export const FINAL_CONFIRM_SFX_KEY = "level1_dialogue_confirm_final_sfx";
...
export function dialogueConfirmSfxKeyForState(
  ...
  if (step.kind === "story-caption") {
    return step.requireConfirm ? FINAL_CONFIRM_SFX_KEY : null;
  }
  ...
  return state.stepIndex >= phase.steps.length - 1
    ? FINAL_CONFIRM_SFX_KEY
    : NORMAL_CONFIRM_SFX_KEY;
}
